...
const ArtEffects = () => {
  ...
  return (
    <div className="art-effects-container">
      ...
      <div className="image-container">{uploadedImage && <img className="uploaded-image" src={uploadedImage} alt="Uploaded with Art Effect" />}</div>
      <div className="flex-container">
        <a href="https://www.linkedin.com/in/ahmad-afriza-ez4-ab9173276/">
          <img className="ic" src="/img/linkedin.png" alt="linkedin" />
        </a>
        <a href="https://www.instagram.com/ahmdfrizza/?hl=en">
          <img className="ic" src="/img/instagram.png" alt="instragram" />
        </a>
      </div>
    </div>
  );
